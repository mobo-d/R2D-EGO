...
%--------------------------------------------------------------------------
    ...
    properties(SetAccess = private)
        RefPoint;  % reference point for HV 
    end
    methods
        ...
        function Setting(obj)
            ...
            if obj.M == 2
                obj.K = obj.ParameterSet(2);
            elseif obj.M == 4
                obj.K = obj.ParameterSet(6);
            else
            ...
            if obj.M == 3 
                obj.RefPoint = 7.5.*ones(1,obj.M); 
            elseif obj.M == 4 
                obj.RefPoint = 9.5.*ones(1,obj.M); 
            elseif obj.M == 6 
                obj.RefPoint = 13.5.*ones(1,obj.M); 
            elseif obj.M == 8 
                obj.RefPoint = 17.5.*ones(1,obj.M); 
            elseif obj.M == 10
                obj.RefPoint = 21.5.*ones(1,obj.M); 
            end
        end
